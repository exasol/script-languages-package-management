...
from exasol.exaslpm.pkg_mgmt.cmd_executor import (CommandExecutor, CommandResult)
...
def mock_command_result():
    ...
    return CommandResult(fn_ret_code=fn_ret_code, stdout=stdout_iter, stderr=stderr_iter)
